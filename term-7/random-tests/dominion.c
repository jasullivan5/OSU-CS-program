...
// Smithy function for assignment 2
// Bug introduced: Moved discardCard call into for loop
...
// Bug introduced: Removed -1 from assignment of cardDrawn
...
// Bug Introduced: removed if (i != currentPlayer) from second for loop
...
// Bug introduced: Removed break statement from second if block
